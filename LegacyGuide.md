...
The client will call your block of code passing in the **sessionID** of your just created session. If an error occurs, the **error** object will contain the details.
